...
VL_ATTR_COLD void Vf1_fsm___024root__trace_init_sub__TOP__0(Vf1_fsm___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+3,"en", false,-1);
    tracep->declBus(c+4,"data_out", false,-1, 7,0);
    tracep->declBus(c+5,"curr_state", false,-1, 31,0);
    tracep->declBus(c+6,"nxt_state", false,-1, 31,0);
...
VL_ATTR_COLD void Vf1_fsm___024root__trace_full_sub_0(Vf1_fsm___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullIData(oldp+5,(vlSelf->f1_fsm__DOT__curr_state),32);
    bufp->fullIData(oldp+6,((((((((((0U == vlSelf->f1_fsm__DOT__curr_state) 
                              ...
                              ? ((0U == vlSelf->f1_fsm__DOT__curr_state)
                                  ? 1U : ((1U == vlSelf->f1_fsm__DOT__curr_state)
                                           ? 2U : (
                                                   (2U 
                                                    == vlSelf->f1_fsm__DOT__curr_state)
                                                    ? 3U
                                                    : 
                                                   ((3U 
                                                     == vlSelf->f1_fsm__DOT__curr_state)
